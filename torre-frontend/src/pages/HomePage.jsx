  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow text-center py-20 px-4 bg-gradient-to-b from-gray-50 to-white">
        <h1 className="text-4xl font-bold mb-4 text-gray-800">Welcome to Torre Challenge</h1>
        <p className="text-lg text-gray-600 mb-10">Explore opportunities, discover talent, and save your favorites with ease.</p>
